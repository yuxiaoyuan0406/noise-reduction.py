...
if __name__ == '__main__':
    ...
    # sample
    t_chopped_hp_smp, x_chopped_hp_smp = util.sample(x_chopped_hp, t, 32, 16)
    ...
    ## Time domain plot     
    ax_time_domain = None
    # fig, ax_time_domain = util.plot(t, x, label='origin signal', ax=ax_time_domain, show=True, block=True)
    ...
    fig, ax_time_domain = util.plot(t_chopped_hp_smp, x_chopped_hp_smp, label='chop hp smp', ax=ax_time_domain, show=False, block=True)
